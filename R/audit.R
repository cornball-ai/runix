...
#' out$audit_persisted
#' @export
audit_two_phase <- function(sink, intent, effect, outcome,
    ...
    intent_rec <- .finish_record(intent, cid, "intent", clock())
    ir <- sink$write(intent_rec)
